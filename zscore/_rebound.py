...
for manual_path in manual_files:
    ...
    all_errors.append(df[["delta_r_kepler","delta_v_kepler"]])
...
mu_dr, std_dr = all_errors["delta_r_kepler"].mean(), all_errors["delta_r_kepler"].std()
mu_dv, std_dv = all_errors["delta_v_kepler"].mean(), all_errors["delta_v_kepler"].std()

# =============================
# PASS 2: Z-SCORE + XAI SUMMARY
# =============================
summary = []
...
print("Z-score analysis complete with physics-grounded explainable summary.")
